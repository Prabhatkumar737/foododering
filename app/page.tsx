        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-2xl mx-auto">
              Order from our extensive menu of 60+ mouth-watering dishes crafted with love
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-purple-600 font-semibold px-8 py-4 text-lg bg-transparent"
              >
                📱 Download App
              </Button>
            </div>
